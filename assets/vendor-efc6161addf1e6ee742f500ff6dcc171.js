...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({_registerWithTabsContainer:function(){this.get("tabsContainer").registerTabList(this),Ember.run.once(this,this.selectTab)},_unregisterWithTabsContainer:function(){this.get("tabsContainer").unregisterTabList(this)},"aria-multiselectable":"false",ariaRole:"tablist",attributeBindings:["aria-multiselectable"],classNames:["ivy-tabs-tablist"],focusSelectedTab:function(){this.get("selectedTab").element.focus()},init:function(){this._super.apply(this,arguments),Ember.run.once(this,this._registerWithTabsContainer)},keyDown:function(e){switch(e.keyCode){case 37:case 38:this.selectPreviousTab()
break
